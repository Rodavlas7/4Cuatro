...
SECRET_KEY = 'django-insecure-ade#07)4q(zo48@_4jf8rrgxpqu@05fuj))=f%7g3x^o#l-w%^'
...
'''
Correr en MySQL Consola:


CREATE USER 'django'@'localhost' IDENTIFIED BY '1234';
GRANT ALL PRIVILEGES ON cuatro.* TO 'django'@'localhost';
FLUSH PRIVILEGES;
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'usuarios.authentication.TokenAuthentication',
    ],
